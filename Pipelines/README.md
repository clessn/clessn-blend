...
This folder contains the code of the data pipelines extractors, loader and refiners.  Once all
The old scrapers have been converted to this new ETL methodology, it will become the root of this repo.
