...
## Purpose
This refiner is used to create graphs plotting the "relevance" and "sentiment" of issue categories and parties in the headlines and tweets of media and journalists.  

## Input

Data from Twitter (journalists and media accounts) and data from Radar+ (headlines)
